...
import { Button, Form, Input, Upload, message, Select, Typography, Table } from 'antd';
            ...
            <Form
                ...
                <Form.Item
                    ...
                    rules={[
                        {
                            required: true,
                            message: 'Введите описание конкурса и выполненной задачи или мероприятия',
                        },
                    ]}>
                    <TextArea rows={4} placeholder="Написал Unix совместимое ядро с кастомным uefi бутлоадером за 3 часа с нуля" />
                </Form.Item>
